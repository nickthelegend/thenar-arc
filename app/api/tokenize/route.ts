...
import { complianceCheck, corpusSecurity, holderView, TokenError } from "@/lib/server/ats";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

/**
 * The corpus security, read from Hedera.
 *
...
async function handleGET(req: Request) {
  ...
  try {
    ...
    if (!security) {
      return NextResponse.json({ error: "The corpus security has not been issued yet." }, { status: 503 });
    }
